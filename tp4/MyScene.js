...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        //Instance of my unit cube

        this.tTop = new CGFtexture(this, 'images/mineTop.png');
        this.tSide = new CGFtexture(this, 'images/mineSide.png');
        this.tBottom = new CGFtexture(this, 'images/mineBottom.png');

        this.unitCube = new MyUnitCubeQuad(this, this.tTop, this.tSide, this.tSide, this.tSide, this.tSide, this.tBottom);
