...
export class MyScene extends CGFscene {
    ...
    updateAmbientLights(){
        this.setGlobalAmbientLight(this.ambientIntensity, this.ambientIntensity, this.ambientIntensity, this.ambientIntensity);
    ...
    initMaterials() {
        ...
        this.material4.setDiffuse(0.4, 0.2, 0, 1.0);
