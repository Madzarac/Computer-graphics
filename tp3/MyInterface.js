...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'selectedMaterial', this.scene.materialIDs).name('Selected Material');
         ...
         var f2 = this.gui.addFolder("Global ambient lights");
         f2.add(this.scene, 'ambientIntensity', 0, 1).name('Intensity').onChange(this.scene.updateAmbientLights.bind(this.scene));
